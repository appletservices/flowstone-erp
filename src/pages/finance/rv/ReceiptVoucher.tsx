...
export default function ReceiptVoucher() {
    ...
    useSetPageHeader("Receipt  Voucher", "Manage receipt vouchers and transactions");
    ...
    const fetchVouchers = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/finance/receipt/list`, {
                headers: {
        ...
        <div className="space-y-6">
            <div className="bg-card rounded-xl border border-border">
                <div className="p-4 border-b border-border flex flex-col sm:flex-row items-center justify-between gap-4">
                    <h3 className="font-semibold text-lg">All Receipt Vouchers</h3>
                                        ...
                                        <TableCell>
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    <DropdownMenuItem onClick={() => navigate(`/finance/receipt-voucher/edit/${item.id}`)}>
