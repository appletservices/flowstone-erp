...
export default function ReceiptVoucherForm() {
    ...
    const onSubmit = async (data: FormValues) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/finance/receipt/store`, {
                method: "POST",
                headers: authHeaders,
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                <Button variant="outline" size="icon" onClick={() => navigate("/finance/receipt-voucher")}>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-4">
                            <Button type="button" variant="outline" onClick={() => navigate("/finance/receipt-voucher")}>Cancel</Button>
