  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        ...
        <Button onClick={() => navigate("/production/opening/new")}>
            ...
            {isLoading ? (
              ...
              data.map((record) => (
                <TableRow key={record.id}>
                  ...
                  <TableCell className="text-right">{record.per_unit}</TableCell>
                  <TableCell className="text-right">{record.total_cost}</TableCell>
