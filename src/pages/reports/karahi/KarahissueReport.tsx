...
export default function KarahissueReport() {
  ...
  const handleFilter = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/reports/issue/karahi?${queryParams.toString()}`,
        {
          headers: {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Filter and view katae issue transactions
          </p>
        </div>
