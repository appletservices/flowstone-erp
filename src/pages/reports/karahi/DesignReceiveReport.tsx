...
export default function DesignReceiveReport() {
  ...
  const handleFilter = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/reports/receive/karahi-design?${queryParams.toString()}`,
        {
          headers: {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Design Receive Report</h1>
          <p className="text-muted-foreground mt-1">
            Filter and view Design receive transactions
          </p>
        </div>
